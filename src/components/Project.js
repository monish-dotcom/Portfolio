...
export default function Project() {
  const projects = [
    ...
    },
    {
      ...
      link: "https://github.com/monish-dotcom/Portfolio-monishpraveen",
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from- to-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-red-100 via-purple-100 to-blue-100 bg-clip-text text-transparent">
            My Projects
          </h2>
          <p className="mt-4 text-xl text-center text-gray-100 font-semibold">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <a
                href={project.link}
                target="_blank"
                className="inline-flex items-center text-red-600 hover:text-indigo-800 font-semibold transition-all duration-200"
              >
                View Project
