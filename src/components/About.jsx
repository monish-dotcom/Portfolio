...
function About({ onGetInTouch }) {
  return (
    <div className="min-h-screen w-full ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Hero Section */}
        <div className="text-center space-y-8 mb-16">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-red-100 via-purple-200 to-blue-100 bg-clip-text text-transparent">
            Hi, I'm MONISH PRAVEEN
          </h1>
          <p className="text-xl text-gray-100 max-w-3xl mx-auto leading-relaxed">
            I'm a passionate Full Stack Developer building modern web
            applications and creating seamless user experiences. I love turning
        ...
        <div className="relative flex justify-center mb-16">
          <div className="absolute inset-0 bg-gradient-to-r from-red-600 via-purple-600 to-blue-500 rounded-full blur-lg opacity-20"></div>
          <img
            src={myPhoto}
            alt="Profile"
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <p className="text-lg text-gray-600">
              I started my journey in web development back in 2024,from crafting
              pixel-perfect UIs to architecting scalable backend systems.
            </p>
            <p className="text-lg text-gray-600">
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-red-600 via-purple-600 to-blue-500 p-12 rounded-xl text-white text-center">
